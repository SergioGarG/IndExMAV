// Extended Kalman Filter without delay correction
...
{
	ros::init(argc, argv, "ekf_wo_delay");
	...
	while (ros::ok())
	{
		...
		if(are_equal==true)
		{
			...
			correctorimu.corregir_imu(prediccion.estado_predictor,prediccion.varianza_predictor, z_imu);
